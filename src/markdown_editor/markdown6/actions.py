...
MENU_STRUCTURE: list[MenuDef] = [
    ...
    MenuDef("&View", [
        ...
        ActionDef("view.toggle_editor", "Toggle &Editor", "_toggle_editor",
                  checkable=True, checked_setting="view.show_editor", checked_default=True,
                  palette_name="Toggle Editor", palette_category="View"),
