...
from fun.markdown.settings import get_settings, DEFAULT_SETTINGS, DEFAULT_SHORTCUTS
...
class SettingsDialog(QDialog):
    ...
    def _create_shortcuts_page(self) -> QWidget:
        ...
        self.shortcuts_table.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
