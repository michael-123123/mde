...
class TestMermaidClientSideFallback:
    ...
    @patch("fun.markdown6.mermaid_service.has_mermaid", return_value=False)
...
class TestMermaidService:
    ...
    def test_format_error(self):
        from fun.markdown6.mermaid_service import _format_error
    ...
    def test_get_mermaid_css_light(self):
        from fun.markdown6.mermaid_service import get_mermaid_css
    ...
    def test_get_mermaid_js_fallback(self):
        from fun.markdown6.mermaid_service import get_mermaid_js
        js = get_mermaid_js()
        assert "mermaid" in js
        assert "cdn.jsdelivr.net" in js

    @patch("fun.markdown6.tool_paths.get_mmdc_path", return_value=None)
    def test_render_without_mmdc(self, mock_path):
        from fun.markdown6.mermaid_service import render_mermaid, clear_cache
        clear_cache()
    ...
    @patch("fun.markdown6.mermaid_service._render_mermaid_impl")
