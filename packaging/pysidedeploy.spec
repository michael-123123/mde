...
extra_args = --noinclude-qt-translations --include-package=markdown_editor --include-package-data=markdown_editor --include-package=pygments --include-package=markdown --include-package-data=docx --static-libpython=no --noinclude-dlls=libsmime3.so --noinclude-dlls=libfontconfig.so.1
